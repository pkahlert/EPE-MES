...
#include "FlashingLeds-CLAShared.h"
...
// It assigns only the program memory by default, the User can edit the file
// for data RAM allocation to the CLA .
// It also forces Task 8 which is used to carry out any initialization function
// on variables residing in the CLAtoCPUMsgRAM.  This task (task 8) must be defined
// on the CLA for this function to work.
void CLA_Init()
{ 
