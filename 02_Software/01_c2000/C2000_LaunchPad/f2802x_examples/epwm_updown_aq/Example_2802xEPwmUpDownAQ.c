...
void InitEPwm2Example()
{
	...
	PWM_setActionQual_CntUp_CmpB_PwmB(myPwm2, PWM_ActionQual_Set);      // Set PWM1B on event B, up count
	PWM_setActionQual_CntDown_CmpB_PwmB(myPwm2, PWM_ActionQual_Clear);  // Clear PWM1B on event B, down count
...
void InitEPwm3Example(void)
{
	...
	PWM_setActionQual_CntUp_CmpB_PwmB(myPwm3, PWM_ActionQual_Set);      // Set PWM1B on event B, up count
	PWM_setActionQual_CntDown_CmpB_PwmB(myPwm3, PWM_ActionQual_Clear);  // Clear PWM1B on event B, down count
