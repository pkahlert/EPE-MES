...
// Used by CLA initialization function
extern Uint16 Cla1Prog_Start, Cla1funcsRunStart, Cla1funcsLoadStart, Cla1funcsLoadSize;
...
{ 
   ...
   // task code and in the CLA_Shared.h header file
...
//	Cla1Regs.MMEMCFG.bit.RAM1E = 1;		// Configure RAM L2, F28035 as CLA data memory 1
   ...
   // Enable the CLA interrupt 8 (Allow CLA to be interrupted)
