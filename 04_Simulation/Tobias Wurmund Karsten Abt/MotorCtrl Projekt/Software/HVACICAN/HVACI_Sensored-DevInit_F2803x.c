...
//T	// changed
   ...
   //------------------------------------------------
//T	// changed
// CLA has features that are useful in parallel programming
// Maybe the CAN project needs some of these features
...
//--------------------------------------------------------------------------------------
//T	// CAN GPIO inizialisation is done after DeviceInit();
//  GPIO-30 - PIN FUNCTION = --Spare--
//T	//	GpioCtrlRegs.GPAMUX2.bit.GPIO30 = 0;	// 0=GPIO,  1=CANRX-A,  2=Resv,  3=Resv
//T	//	GpioCtrlRegs.GPADIR.bit.GPIO30 = 0;		// 1=OUTput,  0=INput 
...
//T	//	GpioCtrlRegs.GPAMUX2.bit.GPIO31 = 0;	// 0=GPIO,  1=CANTX-A,  2=Resv,  3=Resv
//T	//	GpioCtrlRegs.GPADIR.bit.GPIO31 = 1;		// 1=OUTput,  0=INput 
//	GpioDataRegs.GPACLEAR.bit.GPIO31 = 1;	// uncomment if --> Set Low initially
//T	//	GpioDataRegs.GPASET.bit.GPIO31 = 1;		// uncomment if --> Set High initially
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
