###########################################################################
## Makefile generated for Simulink model 'Koordinatentransfer1'. 
## 
## Makefile     : Koordinatentransfer1.mk
## Generated on : Wed Jan 13 08:09:41 2016
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Koordinatentransfer1.exe
...
PRODUCT_NAME              = Koordinatentransfer1
MAKEFILE                  = Koordinatentransfer1.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Koordinatentransfer1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Koordinatentransfer1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Koordinatentransfer1.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Koordinatentransfer1_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Koordinatentransfer1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Koordinatentransfer1_grt_rtw/Koordinatentransfer1.c $(START_DIR)/Koordinatentransfer1_grt_rtw/rtGetInf.c $(START_DIR)/Koordinatentransfer1_grt_rtw/rtGetNaN.c $(START_DIR)/Koordinatentransfer1_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = Koordinatentransfer1.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/Koordinatentransfer1_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
