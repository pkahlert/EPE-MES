###########################################################################
## Makefile generated for Simulink model 'Inverses'. 
## 
## Makefile     : Inverses.mk
## Generated on : Thu Jan 07 13:43:45 2016
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Inverses.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Inverses_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Inverses_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Inverses.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Inverses_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Inverses -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Inverses_grt_rtw/Inverses.c $(START_DIR)/Inverses_grt_rtw/Inverses_data.c $(START_DIR)/Inverses_grt_rtw/rtGetInf.c $(START_DIR)/Inverses_grt_rtw/rtGetNaN.c $(START_DIR)/Inverses_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = Inverses.obj Inverses_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/Inverses_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
