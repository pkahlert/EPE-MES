###########################################################################
## Makefile generated for Simulink model 'R'. 
## 
## Makefile     : R.mk
## Generated on : Wed Jan 13 08:09:55 2016
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/R.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = R_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/R.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/R_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=R -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/R_grt_rtw/R.c $(START_DIR)/R_grt_rtw/rtGetInf.c $(START_DIR)/R_grt_rtw/rtGetNaN.c $(START_DIR)/R_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = R.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
