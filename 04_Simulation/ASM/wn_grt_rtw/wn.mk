###########################################################################
## Makefile generated for Simulink model 'wn'. 
## 
## Makefile     : wn.mk
## Generated on : Wed Jan 13 08:10:17 2016
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/wn.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = wn_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = wn_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/wn.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/wn_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=wn -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/wn_grt_rtw/rtGetInf.c $(START_DIR)/wn_grt_rtw/rtGetNaN.c $(START_DIR)/wn_grt_rtw/rt_nonfinite.c $(START_DIR)/wn_grt_rtw/wn.c $(START_DIR)/wn_grt_rtw/wn_data.c rt_logging.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj wn.obj wn_data.obj rt_logging.obj
